...
export const routes: RouteInfo[] = [
  ...
  {path:'/classes',kind:'content',h1:'Mistfall Hunter Classes — Hub',answer:'All six Mistfall Hunter class guides in one place.'},
  {path:'/builds',kind:'content',h1:'Mistfall Hunter Builds — Hub',answer:'All six Mistfall Hunter class build guides in one place.'},
  {path:'/maps',kind:'content',h1:'Mistfall Hunter Maps — Hub',answer:'Hallowgrove and Brandrgarde map guides plus the Interactive Map tool.'},
  {path:'/bosses',kind:'content',h1:'Mistfall Hunter Bosses — Hub',answer:'Cursed Moonwane, Salmar and Einherjar boss guides in one place.'},
  {path:'/guides',kind:'content',h1:'Mistfall Hunter Guides — Hub',answer:'All Mistfall Hunter guides in one place.'},
  {path:'/codes',kind:'content',h1:'Mistfall Hunter Codes & Rewards — Hub',answer:'Codes, Twitch Drops and Open Beta mail status in one place.'},
