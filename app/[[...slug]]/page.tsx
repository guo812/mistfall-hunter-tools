...
function Home({ copy }: { copy: CopyRoute }) {
  ...
  return <main className="shell"><section className="hero"><div><p className="eyebrow">Unofficial fan resource · Updated August 2026</p><h1>{copy.h1}</h1><p className="lede">{copy.directAnswer}</p><div className="cta-row"><Link className="button primary" href="/class-quiz">Find My Class</Link><Link className="button secondary" href="/guides/getting-started">Browse Guides</Link><a className="button steam" href={steam} rel="noreferrer">Play on Steam</a></div></div></section>
